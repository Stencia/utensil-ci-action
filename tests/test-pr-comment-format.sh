...
EXPECTED=$'Email address\tscripts/test_export_data.py:41\tlow\tReview\t[Dismiss](https://utensil.tools/my-repos?repo=acme%2Fwidgets&dismissRule=piiEmail&dismissFile=scripts%2Ftest_export_data.py&dismissLine=41)'
[[ "$ROWS" == "$EXPECTED" ]] \
